# netex-java-model [![Build and push](https://github.com/entur/netex-java-model/actions/workflows/push.yml/badge.svg)](https://github.com/entur/netex-java-model/actions/workflows/push.yml)
